...
def get_analysis(paper: json, google_api_key = None) -> dict:
    ...
    pdf_prompt = PromptTemplate(
        ...
        -- Each Sections shouldn't be less than 10000 words
        
        Focus on clarity and accuracy in your summary. Use academic language but avoid unnecessary jargon. Not less than 50000 words.
        """
    )
    ...
    html_prompt = PromptTemplate(
      ...
      3. Styling:
        ...
        - Font: Arial/Poppins for body text, size 16px, line height 1.6 color #a0aec0
        - Title: 28px, centered, bold,=Color Dark Cyan
        - Authors: 16px, centered, italic,
        - Section headers: 24px, bold color: Dark Cyan
        - Subsection too.

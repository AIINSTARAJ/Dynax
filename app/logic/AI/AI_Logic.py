...
def get_analysis(paper: json, google_api_key = None) -> dict:
    ...
    pdf_prompt = PromptTemplate(
        ...
        OUTPUT INSTRUCTIONS:
        Create a detailed academic summary of this paper with the following sections:
        ...
        Focus on clarity and accuracy in your summary. Use academic language but avoid unnecessary jargon.
        """
    )
    
    # Prompt for HTML version with clear styling guidance
    html_prompt = PromptTemplate(
        input_variables=["title", "authors", "pdf_content"],
        template="""
        You are an expert HTML formatter for academic content. Convert the following research summary into a well-styled HTML document.
        ...
        2. Styling:
           ...
           - Text: Justified paragraphs with 18px bottom margin
        ...
        Return a complete, valid HTML document that presents the academic content professionally.
        """
    )
